...
export default function OzSearch({prompts}: {prompts: Prompt[]}) {
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between mb-2">
                      ...
                      {prompt.id.startsWith("obsidian-") ? (
                        <Link
                          href={`/shop/${prompt.id.replace("obsidian-", "")}`}
                          className="px-4 py-2 bg-[#c10002] hover:bg-[#a00001] text-white text-sm rounded-lg transition-colors duration-200 flex-shrink-0 ml-4 whitespace-nowrap">
                          🔒 Shop
                        </Link>
                      ) : (
                        <button
