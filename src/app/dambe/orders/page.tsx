...
export default function DambeOrdersPage() {
  ...
  if (!isAdmin) {
    return (
      <div className="min-h-screen bg-white flex flex-col items-center justify-center px-6 text-center">
        ...
        <Link href="/dambe" className="mt-6 text-[11px] text-gray-400 font-black uppercase tracking-widest">
          ← 가격표로
        </Link>
      </div>
    )
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900">
      <div className="px-5 pt-12 pb-6 bg-white border-b border-gray-100">
        <div className="max-w-2xl mx-auto">
          ...
          <h1 className="text-3xl font-black tracking-tight mt-4">픽업 주문 (담배)</h1>
